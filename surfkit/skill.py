    ...
    def generate_tasks(
        ...
        if len(self.requirements) > 0:
            ...
            prompt = (
                ...
                "Please generate tasks that a user could take which will excercise this skill, "
                ...
                f"Please return {n_permutations} for the tasks, for example if I need 2 stories you would return "
                '{"tasks": ["Find stays from october 2nd to 3rd", "Find stays from January 15th-17th"]}'
            )
            ...
            gen_tasks = gen_tasks[:n_permutations]
